...
<link rel="stylesheet" type="text/css" href="/huiadmin/lib/Hui-iconfont/1.0.8/iconfont.css" />
...
@yield('extend-css')
<!--[if IE 6]>
<script type="text/javascript" src="http:///huiadmin/lib.h-ui.net/DD_belatedPNG_0.0.8a-min.js" ></script>
<script>DD_belatedPNG.fix('*');</script>
<![endif]-->
<!--/meta 作为公共模版分离出去-->

<title>DFCMFX-@yield('title')</title>
<meta name="keywords" content="带翻车没发现内容管理框架">
<meta name="description" content="带翻车没发现内容管理框架">
</head>
<body>