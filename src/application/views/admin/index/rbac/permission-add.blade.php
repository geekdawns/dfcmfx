        ...
        <form action="" method="post" class="form form-horizontal" id="form-admin-permission-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" id="permissionTitle" name="title" datatype="*4-16" nullmsg="权限名称不能为空">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>前置标识：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" id="preName" name="pre_code" datatype="*4-16" nullmsg=前置不能为空">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>后置标识：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" id="sufName" name="suf_code" datatype="*4-16" nullmsg=后置不能为空">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <label class="radio-inline">
                        <input type="radio" name="status" id="" value="0" checked> 启用
                    </label>
                    <label class="radio-inline">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="" id="permissionCondition" name="condition">
                </div>
            </div>
            <div class="row cl">
